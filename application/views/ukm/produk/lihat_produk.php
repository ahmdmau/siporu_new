                                    ...
                                    <div class="widget-header bordered d-flex align-items-center">
                                        ...
                                        <div class="widget-options">
                                            <div class="btn-group" role="group">
                                                <a class="btn btn-gradient-01" href="<?php echo site_url('ukm/produk/tambah_produk') ?>">Tambah Produk</a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions">
                                                            <a href="<?php echo site_url('ukm/produk/edit/'. $p->id_produk) ?>">
                                                                <i class="la la-edit edit"></i>
                                                            </a>
                                                            <a href="" id="hapusData" data-toggle="modal" data-target="#modal-centered" onclick="confirm('<?php echo site_url('ukm/produk/hapus/'.$p->id_produk);?>')",'Title');"><i class="la la-close delete"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
